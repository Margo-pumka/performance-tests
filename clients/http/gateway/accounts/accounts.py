...
class AccountsGatewayHTTPClient(HttpClient):
    ...
    def open_deposit_account(self, request: OpenDepositAccountRequestDict) -> Response:
        """
    ...
    def open_savings_account(self, request: OpenSavingsAccountRequestDict) -> Response:
        """
