...
from clients.http.gateway.accounts.schema import GetAccountsQuerySchema, OpenCreditCardAccountRequestSchema, \
    OpenCreditCardAccountResponseSchema, OpenDebitCardAccountRequestSchema, OpenDebitCardAccountResponseSchema, \
