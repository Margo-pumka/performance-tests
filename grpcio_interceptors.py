...
channel = grpc.intercept_channel(channel, SimpleLoggingInterceptor())

stub = UsersGatewayServiceStub(channel)

request = GetUserRequest(id="53ea8152-d4d7-43e8-a2a0-55740b748e5a")
